...
import { SubscribeButton } from './SchemeAlerts';
      ...
      <div className="scheme-modal-card view-enter" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="scheme-modal-header">
          ...
          <div style={{ position: 'absolute', top: '1.25rem', right: '1.25rem', display: 'flex', gap: '0.5rem' }}>
            ...
            {/* Feature 3: Subscribe for deadline alerts */}
            <SubscribeButton scheme={scheme} lang={lang} />
            ...
            <div className="tab-pane-content">
              <div className="grid-2">
                ...
                <div className="section-block">
                  ...
                  {/* Feature 4: DocumentTracker with persistent checkboxes + progress ring */}
                  <DocumentTracker scheme={scheme} lang={lang} />
                </div>
              </div>
            </div>
          )}
